...
public class TQLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TQLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLiteral_ExpressionAccess().getAlternatives(), "rule__Literal_Expression__Alternatives");
			...
			builder.put(grammarAccess.getAnd_ExpressionAccess().getGroup(), "rule__And_Expression__Group__0");
			builder.put(grammarAccess.getAnd_ExpressionAccess().getGroup_1(), "rule__And_Expression__Group_1__0");
			...
			builder.put(grammarAccess.getEquals_ExpressionAccess().getGroup(), "rule__Equals_Expression__Group__0");
			builder.put(grammarAccess.getEquals_ExpressionAccess().getGroup_1(), "rule__Equals_Expression__Group_1__0");
			builder.put(grammarAccess.getNotEquals_ExpressionAccess().getGroup(), "rule__NotEquals_Expression__Group__0");
			builder.put(grammarAccess.getNotEquals_ExpressionAccess().getGroup_1(), "rule__NotEquals_Expression__Group_1__0");
			builder.put(grammarAccess.getLess_ExpressionAccess().getGroup(), "rule__Less_Expression__Group__0");
			builder.put(grammarAccess.getLess_ExpressionAccess().getGroup_1(), "rule__Less_Expression__Group_1__0");
			builder.put(grammarAccess.getGreater_ExpressionAccess().getGroup(), "rule__Greater_Expression__Group__0");
			builder.put(grammarAccess.getGreater_ExpressionAccess().getGroup_1(), "rule__Greater_Expression__Group_1__0");
			builder.put(grammarAccess.getMultiply_ExpressionAccess().getGroup(), "rule__Multiply_Expression__Group__0");
			builder.put(grammarAccess.getMultiply_ExpressionAccess().getGroup_1(), "rule__Multiply_Expression__Group_1__0");
			builder.put(grammarAccess.getDivide_ExpressionAccess().getGroup(), "rule__Divide_Expression__Group__0");
			builder.put(grammarAccess.getDivide_ExpressionAccess().getGroup_1(), "rule__Divide_Expression__Group_1__0");
			builder.put(grammarAccess.getAdd_ExpressionAccess().getGroup(), "rule__Add_Expression__Group__0");
			builder.put(grammarAccess.getAdd_ExpressionAccess().getGroup_1(), "rule__Add_Expression__Group_1__0");
			builder.put(grammarAccess.getSubtract_ExpressionAccess().getGroup(), "rule__Subtract_Expression__Group__0");
			builder.put(grammarAccess.getSubtract_ExpressionAccess().getGroup_1(), "rule__Subtract_Expression__Group_1__0");
			builder.put(grammarAccess.getSelf_ExpressionAccess().getGroup(), "rule__Self_Expression__Group__0");
			...
			builder.put(grammarAccess.getMapped_ColumnAccess().getTargetAssignment_0(), "rule__Mapped_Column__TargetAssignment_0");
			builder.put(grammarAccess.getMapped_ColumnAccess().getSourceAssignment_2(), "rule__Mapped_Column__SourceAssignment_2");
			...
			builder.put(grammarAccess.getAnd_ExpressionAccess().getOperatorAssignment_1_1(), "rule__And_Expression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getAnd_ExpressionAccess().getRightAssignment_1_2(), "rule__And_Expression__RightAssignment_1_2");
			...
			builder.put(grammarAccess.getEquals_ExpressionAccess().getOperatorAssignment_1_1(), "rule__Equals_Expression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getEquals_ExpressionAccess().getRightAssignment_1_2(), "rule__Equals_Expression__RightAssignment_1_2");
			builder.put(grammarAccess.getNotEquals_ExpressionAccess().getOperatorAssignment_1_1(), "rule__NotEquals_Expression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getNotEquals_ExpressionAccess().getRightAssignment_1_2(), "rule__NotEquals_Expression__RightAssignment_1_2");
			builder.put(grammarAccess.getLess_ExpressionAccess().getOperatorAssignment_1_1(), "rule__Less_Expression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getLess_ExpressionAccess().getRightAssignment_1_2(), "rule__Less_Expression__RightAssignment_1_2");
			builder.put(grammarAccess.getGreater_ExpressionAccess().getOperatorAssignment_1_1(), "rule__Greater_Expression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getGreater_ExpressionAccess().getRightAssignment_1_2(), "rule__Greater_Expression__RightAssignment_1_2");
			builder.put(grammarAccess.getMultiply_ExpressionAccess().getOperatorAssignment_1_1(), "rule__Multiply_Expression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getMultiply_ExpressionAccess().getRightAssignment_1_2(), "rule__Multiply_Expression__RightAssignment_1_2");
			builder.put(grammarAccess.getDivide_ExpressionAccess().getOperatorAssignment_1_1(), "rule__Divide_Expression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getDivide_ExpressionAccess().getRightAssignment_1_2(), "rule__Divide_Expression__RightAssignment_1_2");
			builder.put(grammarAccess.getAdd_ExpressionAccess().getOperatorAssignment_1_1(), "rule__Add_Expression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getAdd_ExpressionAccess().getRightAssignment_1_2(), "rule__Add_Expression__RightAssignment_1_2");
			builder.put(grammarAccess.getSubtract_ExpressionAccess().getOperatorAssignment_1_1(), "rule__Subtract_Expression__OperatorAssignment_1_1");
			builder.put(grammarAccess.getSubtract_ExpressionAccess().getRightAssignment_1_2(), "rule__Subtract_Expression__RightAssignment_1_2");
