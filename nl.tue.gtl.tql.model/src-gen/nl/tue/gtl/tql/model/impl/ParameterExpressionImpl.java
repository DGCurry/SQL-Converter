 ...
 * </p>
 * <ul>
 *   <li>{@link nl.tue.gtl.tql.model.impl.ParameterExpressionImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterExpressionImpl extends MinimalEObjectImpl.Container implements ParameterExpression {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.PARAMETER_EXPRESSION;
	}
			...
			if (parameter != oldParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModelPackage.PARAMETER_EXPRESSION__PARAMETER, oldParameter, parameter));
			}
		}
		return parameter;
	}
	...
	public void setParameter(Parameter newParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PARAMETER_EXPRESSION__PARAMETER,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModelPackage.PARAMETER_EXPRESSION__PARAMETER:
			if (resolve)
				return getParameter();
