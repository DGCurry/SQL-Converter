 ...
 * </p>
 * <ul>
 *   <li>{@link nl.tue.gtl.tql.model.impl.ColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link nl.tue.gtl.tql.model.impl.ColumnImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column {
	...
	public void setType(Type newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLUMN__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ModelPackage.COLUMN__NAME:
			return getName();
		case ModelPackage.COLUMN__TYPE:
			return getType();
		}
